<template>
  <div :class="this.$store.state.ui.primaryNavigation.visible == true ? 'primary-navigation primary-navigation--visible' : 'primary-navigation'" >
    ...
    <ul class="primary-navigation_list">
      <li class="primary-navigation_list-item"><Button variant="secondary" text="Record session" /></li>
      <li class="primary-navigation_list-item"><Button variant="secondary" text="Screen share" /></li>
      <li class="primary-navigation_list-item"><Button variant="secondary" text="leave session" /></li>
    </ul>
