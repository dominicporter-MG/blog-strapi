<template>
  <div :class="this.$store.state.ui.primaryNavigation.visible == true ? 'primary-navigation primary-navigation--inline primary-navigation--visible' : 'primary-navigation primary-navigation--inline'" >
    ...
    <ul class="primary-navigation_list">
      ...
      <li  v-for="(navItem, index) in navItems" :key="index" class="primary-navigation_list-item" @click="toggleMenu(buildNavLink(navItem.location))"><router-link :to="buildNavLink(navItem.location)" class="primary-navigation_link"><span class="link_text">{{navItem.text}}</span></router-link></li>
    
      <li  v-if="this.$store.getters.loggedInUser" class="primary-navigation_list-item"><a href="#n" class="primary-navigation_link" @click.prevent="onLogout"><span class="link_text">Sign out</span></a></li>
