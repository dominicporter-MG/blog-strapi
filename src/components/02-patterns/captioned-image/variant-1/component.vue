<template>
  <figure :class="classes">
    <img :src="this.source" />
    <T3 v-if="this.caption">{{ this.caption }}</T3>
  </figure>
</template>
...
<script>
  ...
  import H1                     from '@/components/01-arrangements/h1/variant-2/component'
  import H2                     from '@/components/01-arrangements/h2/variant-2/component'
  ...
  export default {
    ...
    computed: {
      classes() {
        return `captioned-image ${this.classList}`;  
      }
    },
    methods: {
    }
