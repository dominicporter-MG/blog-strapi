<template>
  <div :class="classes">
    ...
    <div class="chatbox_window">
      ...
      <T3><strong>Amanda</strong>Are there any course materials for this session?</T3>
      <T3><strong>Adrian</strong>Yes, Amanda. You can find them over in the resources panel</T3>

    </div>

    <div class="chatbox_tools">
...
<script>
  ...
  export default {
    name: 'Chatbox',
    components: {
      Listen, Container, Layout, PageHeader, ProductList, Logo, PrimaryNavigation, Accordion, SearchableList, ProgressIndicator, AppBar, PageFooter, VideoConference, Pane, Form, LoginForm, Legend, Card, CopyBlock, H1, H2, H3,H4, H5, T1, T2, T3,
